	...
	if (isset($_GET['category_id'])) {		
      ...
      //  echo false;
       ...
       $sql_query = "SELECT username,Activo,Name,Telefono,email FROM tbl_admin WHERE username = ? AND password = ?";
        ...
        $dta = array();
        /*
        $url = 'http://186.1.15.164:8448/gnet_api_movil/index.php/estadistica_ruta';
        $data = array(
            'Ruta' => 'F05',
            'Empresa' => 'UNIMARK',
            'Mes' => date('n'),
        ...
        if ($result === FALSE) { }$dta['Articulos']*/

        $dta[0]['mMetaVenta']       = str_replace(",", "","150,000.00");
        $dta[0]['mVentaReal']       = str_replace(",", "","50,000.00");
        $dta[0]['mVentaDif']        = "100.00";
        $dta[0]['mVntCanti']        = str_replace(",", "","100,000.00");
        $dta[0]['mVntCantiReal']    = str_replace(",", "","10,000.00");
        $dta[0]['mVntCantiDif']     = "90.00";
