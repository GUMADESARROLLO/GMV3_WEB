				...
				<div class="pmd-card-body">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
							<div class="lead">GESTOR DE NOTIFICACIONES</div>
						</div>
					...
					<div class="table-responsive"> 
						...
						<p align="center">Whoops, no hay datos :( !</p>
							...
							<tbody>
								<tr>
									...
									<td>
									    ...
									    <a href="manage-notification.php?id=<?php echo $data['id'];?>" onclick="return confirm('¿Seguro que quieres eliminar esta plantilla?')" >
