					...
					<div class="group-fields clearfix row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group pmd-textfield">
                                ...
                                <input type="text" name="product_sku" id="product_sku" class="form-control" placeholder="SKU" value="<?php echo $row['product_sku'];?>" required>
                            </div>
                        </div>
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display: none">
							<div class="form-group pmd-textfield">
								...
								<input type="text" name="product_price" id="product_price" class="form-control" placeholder="50" required value="100">
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display: none">
							<div class="form-group pmd-textfield" >
								...
								<input type="number" name="product_quantity" id="product_quantity" class="form-control" placeholder="0" value="100" required>
							</div>
						</div>
