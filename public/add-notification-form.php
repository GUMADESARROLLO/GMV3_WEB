...
<div id="content" class="pmd-content content-area dashboard">
	...
	<div class="container-fluid full-width-container">
		...
		<ol class="breadcrumb text-left">
		  ...
		  <li class="active">Nueva Notificacion</li>
		</ol>
		<!--breadcrum end-->
				...
				<div class="pmd-card-body">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="lead">NUEVA NOTIFICACIONES</div>
						</div>
					</div>
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield">
								...
								<input type="text" name="message" id="message" class="form-control" placeholder="Contenido" required>
							</div>
						</div>
					</div>
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="regular1" class="control-label">Imagen Grande ( jpg / png) *</label>
