...
<?php
  ...
  if (isset($_POST['submit'])) {
        ...
        $server_path = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http");
        $server_path .= "://".$_SERVER['HTTP_HOST'];
        $server_path .= str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']);

        $big_image = $server_path.'upload/product/'.$data['product_image'];
